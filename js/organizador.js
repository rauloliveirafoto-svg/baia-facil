...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // ── Estado ─────────────────────────────────────────────────
  // Usar ID do localStorage só se for um ID timestamp válido (> 13 dígitos)
  var _storedId = localStorage.getItem('baia_org_ev') || '';
  var evId      = (_storedId.length > 6) ? _storedId : '';
  var cache     = null;
  var selBaia   = null;
  var manSel    = [];
  var btnMap    = new Map();
